...
export default {
  ...
  safelist: [
    'bg-notion-red-bg', 'bg-notion-orange-bg', 'bg-notion-yellow-bg', 'bg-notion-green-bg',
    'bg-notion-blue-bg', 'bg-notion-purple-bg', 'bg-notion-pink-bg', 'bg-notion-gray-bg',
    'text-notion-red-text', 'text-notion-orange-text', 'text-notion-yellow-text', 'text-notion-green-text',
    'text-notion-blue-text', 'text-notion-purple-text', 'text-notion-pink-text', 'text-notion-gray-text',
  ],
  theme: {
    extend: {
      fontFamily: {
